...
const products = [
  ...
  { name: "Pulse Sensor", price: "3 000 FCFA", image: "assets/images/products/pulse-sensor.png", description: "Capteur de pouls et moniteur de fréquence cardiaque - Biocapteur analogique pour ESP32 (photopléthysmographie PPG)" },
  { name: "Servomoteur SG90", price: "2 500 FCFA", image: "assets/images/products/servomoteur-sg90.png", description: "SG90 Mini servomoteur Hélicoptère à voilure fixe Aéronef télécommandé Composants électroniques" },
  { name: "Ecran OLED", price: "3 500 FCFA", image: "assets/images/products/ecran-oled.png", description: "Module d'affichage OLED I2C IIC 0,96 pouce 12864 128x64 pixels SSD1306 Mini carte d'écran OLED auto-lumineux pour Arduino Raspberry Pi" },
  { name: "Breadbord", price: "2 000 FCFA", image: "assets/images/products/breadboard.png", description: "Breadboards 830 broches Blanc MB-102 Protoboards sans soudure 165X56X8,5 mm Carte PCB" },
  { name: "Module Lora RFM95w", price: "6 500 FCFA", image: "assets/images/products/module-lora-rfm95w.png", description: "Puces RFM95 RFM95W 868 915 Bobine et ruban RFM95W-868S2R RFM95W-915S2R RFM95W-915S2 LORA SX1276 RFM95W-868S2" },
  { name: "Module RFID", price: "2 500 FCFA", image: "assets/images/products/module-rfid.png", description: "Kit RFID RC522 Module capteur de carte IC RF + carte vierge S50 + porte-clés pour Raspberry Pi" },
  { name: "Boite à fils en U", price: "2 500 FCFA", image: "assets/images/products/boite-fils-u.png", description: "TZT Hot Sell 140 pièces Kit de câbles de raccordement sans soudure en forme de U pour carte d'essai Arduino Shield pour Raspberry Pi Drop" },
  { name: "Horloges RTC", price: "2 500 FCFA", image: "assets/images/products/horloge-rtc.png", description: "Module d'horloge en temps réel Module IIC RTC pour Arduino sans batterie" },
  { name: "Keypad", price: "1 500 FCFA", image: "assets/images/products/keypad.png", description: "Clavier à membrane d'usine 4*4/1*4/3*4/4*5 Clavier d'extension MCU Claviers électroniques" },
  { name: "Max31865", price: "3 000 FCFA", image: "assets/images/products/max31865.png", description: "MAX31865 Détecteur de température à résistance platine RTD Module MAX31865" },
  { name: "Capteur Humidité du Sol Capacitif", price: "3 000 FCFA", image: "assets/images/products/capteur-humidite-sol-capacitif.png", description: "Capteur analogique capacitif d'humidité du sol 3,3~5,5 V résistant à la corrosion avec interface à 3 broches à gravité pour Raspberry Pi" },
  { name: "Abaisseur de Tension", price: "2 500 FCFA", image: "assets/images/products/abaisseur-tension.png", description: "Module de réduction de tension réglable LM2596 DC-DC avec voltmètre à affichage numérique LM2596S Alimentation stabilisée 5 A" },
  { name: "DHT22", price: "3 500 FCFA", image: "assets/images/products/dht22.png", description: "Capteur numérique de température et d'humidité à bus unique DHT22 Module AM2302 Blocs électroniques" },
  { name: "Pompe à Eau 5V", price: "3 000 FCFA", image: "assets/images/products/pompe-a-eau-5v.png", description: "Mini pompe à eau submersible 5 V, 80-100 l/h" },
  { name: "Module Suiveur de Ligne", price: "1 500 FCFA", image: "assets/images/products/module-suiveur-de-ligne.png", description: "KY-033 TCRT5000 3 broches pour Arduino Capteur infrarouge à réflexion pour module de suivi et d'évitement d'obstacles" },
  { name: "Jumper Male Male 30CM", price: "1 500 FCFA", image: "assets/images/products/jumper-male-male-30cm.png", description: "OKY0065 Composants électroniques Câble Dupont de 30 cm à 40 broches mâle-mâle pour carte d'essai" },
  { name: "Jumper Male Female 30CM", price: "1 500 FCFA", image: "assets/images/products/jumper-male-female-30cm.png", description: "OKY0065 Composants électroniques Câble Dupont de 30 cm à 40 broches mâle-femelle pour carte d'essai" },
  { name: "Jumper Female Female 30CM", price: "1 500 FCFA", image: "assets/images/products/jumper-female-female-30cm.png", description: "OKY0065 Composants électroniques Câble Dupont de 30 cm à 40 broches femelle-femelle pour carte d'essai" },
  { name: "Jumper Male Male 20CM", price: "1 500 FCFA", image: "assets/images/products/jumper-male-male-30cm.png", description: "OKY0065 Composants électroniques Câble Dupont de 20 cm à 40 broches mâle-mâle pour carte d'essai" },
  { name: "Jumper Male Female 20CM", price: "1 500 FCFA", image: "assets/images/products/jumper-male-female-30cm.png", description: "OKY0065 Composants électroniques Câble Dupont de 20 cm à 40 broches mâle-femelle pour carte d'essai" },
  { name: "Jumper Female Female 20CM", price: "1 500 FCFA", image: "assets/images/products/jumper-female-female-30cm.png", description: "OKY0065 Composants électroniques Câble Dupont de 20 cm à 40 broches femelle-femelle pour carte d'essai" },
  { name: "Kit de Résistance 500pcs", price: "5 000 FCFA", image: "assets/images/products/kit-resistance-500pcs.png", description: "Kit assorti de 500 résistances à film métallique Kit de 30 types de résistances à film métallique Résistance 10R-1M 1 % 1/4 W" },
  { name: "Tuyau Pompe 5V 50M", price: "1 000 FCFA", image: "assets/images/products/tuyau-pompe-5v-50m.png", description: "Tuyau flexible en PVC transparent de 2 mm d'épaisseur, 1 pouce (25 mm de diamètre), 50 m de longueur, pour pompe d'irrigation de jardin" },
  { name: "Relais DC", price: "2 500 FCFA", image: "assets/images/products/relais-dc.png", description: "Module relais 1 canal 5 V JQC-3FF-S-Z avec LED JQC-3FF-S-Z" },
  { name: "Module Haut-parleurs ", price: "3 000 FCFA", image: "assets/images/products/module-haut-parleur2.png", description: "Haut-parleur amplificateur en plastique 3 W 8 R 3 watts 8 ohms Module de reconnaissance vocale 3070 avec terminal" },
  { name: "Capteur de Pluie", price: "3 000 FCFA", image: "assets/images/products/capteur-de-pluie.png", description: "Module de mesure de l'eau de pluie Capteur de pluie Module de capteur de surface des feuilles Haute sensibilité" },
  { name: "Arduino WIFI", price: "12 000 FCFA", image: "assets/images/products/arduino-wifi.png", description: "Cartes de développement ESP32-S3-MINI Modules électroniques Arduino R4 Wifi Minima Carte de développement Ecu Abx00080" },
  { name: "Capteur de Température Corporelle Humaine de Haute Précision (CJMCU-30205)", price: "10 000 FCFA", image: "assets/images/products/capteur-temperature-corporelle-humaine-cjmcu-30205.png", description: "CJMCU-30205 MAX30205MTA Module de capteur de température corporelle humaine à haute précision et basse tension pour la température corporelle humaine" },
  { name: "Moteur BTS7960", price: "4 000 FCFA", image: "assets/images/products/moteur-bts7960.png", description: "Module de commande moteur haute puissance TZT Double BTS7960 43A H-bridge / voiture intelligente DIY Diagnostic actuel pour Arduino" },
  { name: "Alimentation 9V", price: "2 500 FCFA" },
  { name: "Alimentation 12V", price: "2 500 FCFA" },
  { name: "Capteur PH", price: "27 000 FCFA", image: "assets/images/products/capteur-ph.png", description: "Module capteur de pH industriel - Sonde à électrode analogique pour la détection d'une plage de pH comprise entre 0 et 14, l'analyse de la qualité de l'eau et l'analyse chimique" },
  { name: "Electrovan DC 24V", price: "15 000 FCFA", image: "assets/images/products/electrovan-dc.png", description: "Électrovanne 24 V, 1/2 pouce, DN15, vanne de régulation directe en laiton pour l'eau, température normale, application générale, OEM Darhor" },
  { name: "Electrovan DC 12V", price: "5 000 FCFA", image: "assets/images/products/electrovan-dc.png", description: "Électrovanne 12 V, 1/2 pouce, DN15, vanne de régulation directe en laiton pour l'eau, température normale, application générale, OEM Darhor" },
